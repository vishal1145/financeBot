      ...
      <div className="w-full bg-white rounded-lg shadow-lg flex flex-col md:flex-row overflow-hidden h-full">
        ...
        <div className="w-full md:w-1/2 p-10 flex flex-col">
          ...
          <h2 className="text-2xl font-semibold mb-2">
            Admin Login – FinanceBot
          </h2>
          <p className="text-gray-500 text-sm mb-8">
            Monitor user activity, spending alerts, and summaries in one place.
          </p>
              ...
              <div className="flex-1 flex flex-col justify-start items-center px-2 py-4 bg-[#f7f5f2]">
                <div className="w-[90%] bg-[#e9e4dd] rounded-2xl p-4 flex flex-col gap-2 shadow-md mt-2">
                  ...
                  <div className="flex flex-col items-end">
                    <div className="bg-[#d2f8c6] text-gray-800 rounded-lg px-3 py-1.5 text-xs font-medium shadow max-w-[80%]">
                      Hi FinanceBot 💰
                    </div>
                  </div>
                  {/* Bot Message */}
                  <div className="flex flex-col items-start">
                    <div className="bg-white text-gray-800 rounded-lg px-3 py-1.5 text-xs shadow max-w-[80%]">
                      Hey! Welcome back. What would you like to do today?
                    </div>
                  </div>
                  {/* User Message */}
                  <div className="flex flex-col items-end">
                  ...
                  <div className="flex flex-col items-start">
                    <div className="bg-white rounded-xl px-3 py-2 shadow text-xs max-w-full">
                      ...
                      <div className="flex items-center justify-between font-bold border-t border-gray-100 pt-1 mt-1">
                        <span>🔴 Total:</span>
                        <span>$225</span>
                      </div>
                      <div className="mt-2 text-[11px] bg-red-50 text-red-500 rounded px-2 py-1">
                        You've gone over your food budget goal of $100. Try to
                        spend less!
                      </div>
                    </div>
                  </div>
